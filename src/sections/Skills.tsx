...
export const Skills = () => {
  ...
  const activeCategorySkills = skills.filter(skill => skill.category === activeCategory);
        ...
        <div className="mt-12 text-center">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
              <div className="text-2xl font-bold text-blue-600 dark:text-blue-400 mb-1">13+</div>
              <div className="text-sm text-gray-700 dark:text-gray-300">Years of Experience</div>
            </div>
            <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-4">
              <div className="text-2xl font-bold text-green-600 dark:text-green-400 mb-1">Multi</div>
              <div className="text-sm text-gray-700 dark:text-gray-300">Technology Stack</div>
            </div>
            <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-4">
              <div className="text-2xl font-bold text-purple-600 dark:text-purple-400 mb-1">1300+</div>
              <div className="text-sm text-gray-700 dark:text-gray-300">IoT Devices Managed</div>
            </div>
          </div>
        </div>
      </div>
